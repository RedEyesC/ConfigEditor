...
namespace GameFramework.Common
{
	...
	public class ByteBuffer
	{
		...
		public byte ReadByteByPos(int pos)
		{
            position = pos;
			return ReadByte();
		}
        ...
        public int ReadIntByPos(int pos)
        {
            position = pos;
            return ReadInt();
        }
        ...
        public uint ReadUintByPos(int pos)
        {
            position = pos;
            return ReadUint();
        }
        ...
        public float ReadFloatByPos(int pos)
        {
            position = pos;
            return ReadFloat();
        }
        ...
        public short ReadShortByPos(int pos)
        {
            position = pos;
            return ReadShort();
        }
        ...
        public ushort ReadUshortByPos(int pos)
        {
            position = pos;
            return ReadUshort();
        }
